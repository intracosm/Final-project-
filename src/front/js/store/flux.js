			...
			appointments: [
				{
					...
					start_date: new Date("2021-04-26T16:30:00.000Z"),
					end_date: new Date("2021-04-26T18:30:00.000Z"),
				},
				{
					text: "Book Flights to San Fran for Sales Trip",
					start_date: new Date("2021-04-26T19:00:00.000Z"),
					end_date: new Date("2021-04-26T20:00:00.000Z"),
					allDay: true,
				},
				{
					text: "Install New Router in Dev Room",
					start_date: new Date("2021-04-26T21:30:00.000Z"),
					end_date: new Date("2021-04-26T22:30:00.000Z"),
				},
				{
					text: "Approve Personal Computer Upgrade Plan",
					start_date: new Date("2021-04-27T17:00:00.000Z"),
					end_date: new Date("2021-04-27T18:00:00.000Z"),
				},
				{
					text: "Final Budget Review",
					start_date: new Date("2021-04-27T19:00:00.000Z"),
					end_date: new Date("2021-04-27T20:35:00.000Z"),
				},
				{
					text: "New Brochures",
					start_date: new Date("2021-04-27T21:30:00.000Z"),
					end_date: new Date("2021-04-27T22:45:00.000Z"),
				},
				{
					text: "Install New Database",
					start_date: new Date("2021-04-28T16:45:00.000Z"),
					end_date: new Date("2021-04-28T18:15:00.000Z"),
				},
				{
					text: "Approve New Online Marketing Strategy",
					start_date: new Date("2021-04-28T19:00:00.000Z"),
					end_date: new Date("2021-04-28T21:00:00.000Z"),
				},
				{
					text: "Upgrade Personal Computers",
					start_date: new Date("2021-04-28T22:15:00.000Z"),
					end_date: new Date("2021-04-28T23:30:00.000Z"),
				},
				{
					text: "Customer Workshop",
					start_date: new Date("2021-04-29T18:00:00.000Z"),
					end_date: new Date("2021-04-29T19:00:00.000Z"),
					allDay: true,
				},
				{
					text: "Prepare 2021 Marketing Plan",
					start_date: new Date("2021-04-29T18:00:00.000Z"),
					end_date: new Date("2021-04-29T20:30:00.000Z"),
				},
				{
					text: "Brochure Design Review",
					start_date: new Date("2021-04-29T21:00:00.000Z"),
					end_date: new Date("2021-04-29T22:30:00.000Z"),
				},
				{
					text: "Create Icons for Website",
					start_date: new Date("2021-04-30T17:00:00.000Z"),
					end_date: new Date("2021-04-30T18:30:00.000Z"),
				},
				{
					text: "Upgrade Server Hardware",
					start_date: new Date("2021-04-30T21:30:00.000Z"),
					end_date: new Date("2021-04-30T23:00:00.000Z"),
				},
				{
					text: "Submit New Website Design",
					start_date: new Date("2021-04-30T23:30:00.000Z"),
					end_date: new Date("2021-05-01T01:00:00.000Z"),
				},
				{
					text: "Launch New Website",
					start_date: new Date("2021-04-30T19:20:00.000Z"),
					end_date: new Date("2021-04-30T21:00:00.000Z"),
				},
			],
		},
		actions: {
