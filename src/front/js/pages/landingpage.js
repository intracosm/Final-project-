            ...
            <div className="intro-logo jumbo-bg">
                ...
                <div className="landing-body d-flex justify-content-center mb-5">
                    <div className="landing-body-background d-flex justify-content-center">
                        <div>
                            <div><h1 className="d-flex justify-content-center landing-h1">Workout Tutorials</h1></div>
                            <div className="d-flex justify-content-center landing-text"><p>Over 1,000 certified exercises with demonstrations for whether you're at home or on the road.</p></div>
