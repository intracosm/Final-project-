                        ...
                        <div className="landing-body-background d-flex justify-content-center">
                            <div className="fruit-img">
                                <div className="img-overlay">
                                    <div><h1 className="d-flex justify-content-center pt-4 white1">Workout Tutorials</h1></div>
                                    <div className="d-flex justify-content-center landing-text2 white1"><p>Over 1,000 certified exercises with demonstrations for whether you're at home or on the road.</p></div>
                                </div>
                            </div>
                        </div>
