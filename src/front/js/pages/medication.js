            ...
            <div className="mdbkg">
                <div className="medcontent-wrapper">
                    ...
                    <div className="medication-header">
                        <h3 className="mdtxt">Example conditions to search for: Leukemia, Ischemic Stroke, Abdominal Distension, Premenstrual Syndrome, Edema, etc. </h3>
                    </div>

                    <div className="inputdiv"><h1 className="inputhdr">Med search</h1><input className="medsearch" type="text" value={input} onChange={(e) => {
                        setInput(e.target.value)

                    }} />
                        <button className="btn btn-danger" onClick={() => getDrug(input)} >Find</button></div>
                    {
